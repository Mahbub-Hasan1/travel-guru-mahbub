    ...
    return (
        <div style={{background: '#F0F0F0',height:'600px',paddingBottom: '5%',}}>
            <div style={{ width: '30%', margin: '0 auto', padding: '20px', borderRadius: '10px', background: '#fff',marginTop: '10% auto' }}>
                <button className="btn btn-outline-warning " onClick={handleGoogleSignIn}>Continue with Google Login</button><br />
                <button className="btn btn-outline-primary" onClick={handleFacebookSignIn}>Continue with Facebook Login</button>
